...
namespace Practico.Windows
{
    public partial class frmFormasDePago : Form
    {
        ...
        private void TbsNuevo_Click_1(object sender, EventArgs e)
        {
        ...
        private void TbsEditar_Click_1(object sender, EventArgs e)
        {
        ...
        private void TbsBorrar_Click_1(object sender, EventArgs e)
        {
            if (dgvDatos.SelectedRows.Count == 0)
            {
                return;
        ...
        private void TbsActualizar_Click_1(object sender, EventArgs e)
        {
            try
            {
                filterOn = false;
